...
const winePrices = {
  ...
  "Ceretto Moscato d'Asti": "$12 / $48",
  "Raventós Cava de NIT Rosé Brut": "$18 / $72",
  "Laurent Perrier Le Cuvée Brut": "$25 / $100",
  "Laurent Perrier Brut Rosé": "$120",
  "Veuve Clicquot Brut": "$130",
  "Paul Bara Grand Rosé Brut": "$30 / $120",
  "Robert Moncuit Les Grand Blancs": "$150",
  ...
  "Silver Oak Cabernet Sauvignon": "$175",
  "Brandlin Estate Cabernet Sauvignon": "$175",
  "Lail Vineyards Blueprint": "$175",
  "Spottswoode Lyndenhurst": "$175",
  "Nickel & Nickel Cabernet": "$200",
  "Shafer 1.5": "$195",
  "Cade Cabernet Sauvignon": "$210",
  "Darioush Cabernet Sauvignon": "$230",
  "Heitz Trailside Vineyard": "$220",
  "Frias Block 5": "$225",
  "Far Niente Cabernet Sauvignon": "$250",
  "Odette Cabernet Sauvignon": "$290",
  "Macauley Stagecoach Vineyard": "$300",
  "Freemark Abbey Bosché": "$315",
  "Venge Family Reserve": "$350",
  "Lail Vineyards Daniel Cuvée": "$375",
