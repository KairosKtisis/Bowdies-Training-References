...
const AVOID_REASONING_POOL = {
  BOURBON_BOLD: {
    'main': {
      'main-fish-delicate': [
        ...
        { verb: 'overwhelms', why: 'bourbon depth belongs with red meat, not flaky white fish' },
        { verb: 'flattens', why: 'oak-and-vanilla density rolls over the gentle flesh without lifting it' },
      ],
      'main-fish-rich': [
        { verb: 'clashes with', why: 'the oily flesh and the brown-spirit oak refuse to meet cleanly' },
        { verb: 'smothers', why: 'sweet-spirit register doubles the natural fish-richness — no contrast' },
        { verb: 'overwhelms', why: 'bourbon weight needs red meat, not the salmon\'s already-rich oils' },
      ],
      'main-fish-crusted': [
        { verb: 'flattens', why: 'oak-and-vanilla density rolls over the seared crust without lifting it' },
        { verb: 'swallows', why: 'the sweet-spirit register fights the savory sear without a bridge' },
        { verb: 'clashes with', why: 'bourbon\'s sweet weight crowds the rare crust\'s clean char' },
      ],
      'main-poultry': [
        { verb: 'overwhelms', why: 'the bourbon\'s register is too heavy for the chicken\'s mild frame' },
        { verb: 'smothers', why: 'sweet-oak depth rolls over the herbed skin without complement' },
      ],
      DEFAULT: [
        { verb: 'overwhelms', why: 'bourbon depth belongs with red meat, not a flaky main' },
    ...
    'starter': {
      'starter-shellfish': [
        ...
        { verb: 'drowns out', why: 'sweet-oak depth flattens the briny opener instead of lifting it' },
        { verb: 'smothers', why: 'bourbon warmth has no foil against cold, clean shellfish' },
      ],
      'starter-dairy': [
        { verb: 'crowds out', why: 'sweet-oak register curdles next to fresh dairy without acid to balance' },
        { verb: 'clashes with', why: 'bourbon weight buries the milky cheese plate\'s delicate frame' },
      ],
      'starter-meat': [
        { verb: 'underclubs', why: 'the bottle is capable but the rich meat starter deserves a more decisive call' },
        { verb: 'falls short of', why: 'this expression doesn\'t carry the meat opener — a bigger bourbon or Cab earns it' },
      ],
      'starter-herb': [
        { verb: 'overwhelms', why: 'sweet-oak depth rolls over the herb-bright opener' },
        { verb: 'smothers', why: 'the bourbon weight buries the dish\'s garlic-herb lift' },
      ],
      DEFAULT: [
        { verb: 'crowds out', why: 'bourbon depth is wrong for the table\'s opening course' },
        { verb: 'fights', why: 'the spirit register reads heavy on a starter\'s lighter frame' },
      ],
    },
    'soup-salad': {
      'soup-salad-cream': [
        { verb: 'doubles down on', why: 'sweet-oak meets dairy cream with no contrast — both register heavy' },
        { verb: 'flattens', why: 'brown-spirit weight buries the soup\'s creamy base instead of carrying it' },
      ],
      'soup-salad-broth': [
        { verb: 'crowds', why: 'the bourbon has no acid to balance the broth\'s savory base' },
        { verb: 'clashes with', why: 'spirit warmth and the broth\'s salt-and-spice frame refuse each other' },
      ],
      'soup-salad-greens': [
        { verb: 'overshadows', why: 'sweet-oak depth has no business on cold lettuce — no acid to bridge it' },
    ...
    'side': {
      'side-cream': [
        { verb: 'doubles down on', why: 'sweet-spirit oak meets dairy richness with no contrast between them' },
        { verb: 'flattens', why: 'bourbon weight and the side\'s cream pull in the same direction without bridge' },
      ],
      'side-vegetable': [
        { verb: 'overshadows', why: 'sweet-oak depth has nothing to bridge into green vegetable freshness' },
        { verb: 'clashes with', why: 'the bourbon\'s register is wrong for a clean vegetable side — needs crisp white instead' },
      ],
      'side-glazed': [
        { verb: 'doubles down on', why: 'sweet-oak and a sweet glaze double the sugar register with no contrast' },
        { verb: 'overwhelms', why: 'bourbon weight buries the glaze\'s sweetness instead of carrying it' },
      ],
      'side-earthy': [
        { verb: 'overshadows', why: 'the bourbon\'s sweet register fights the side\'s earthy umami without bridge' },
      ],
      'side-starch': [
        { verb: 'crowds', why: 'the bourbon needs the cut, not the supporting starch plate' },
      ],
      DEFAULT: [
    ...
    'dessert': {
      'dessert-chocolate': [
        { verb: 'flattens', why: 'the bourbon\'s heat dulls the chocolate\'s lift instead of carrying it' },
        { verb: 'clashes with', why: 'sweet-oak doubles the cocoa weight without lift' },
      ],
      'dessert-custard': [
        { verb: 'clashes with', why: 'the sweet-oak edge doubles the custard\'s sweetness without contrast' },
        { verb: 'fights', why: 'the spirit\'s spice register pulls against the custard\'s tang' },
      ],
      'dessert-cake-spice': [
        { verb: 'overwhelms', why: 'the bourbon\'s cask weight buries the spice cake\'s delicate cinnamon frame' },
      ],
      'dessert-pastry': [
        { verb: 'crowds', why: 'the bourbon weight has no foil against a warm pastry\'s sugar-and-fry sweetness' },
      ],
      DEFAULT: [
    ...
    'steak': {
      'steak-big': [
        { verb: 'underclubs', why: 'the bourbon\'s register is right but this bottle reads short of the long-bone cut' },
        { verb: 'falls short of', why: 'this expression doesn\'t carry 26+ ounces — a bigger bourbon or a Cab earns it' },
      ],
      'steak-medium': [
        { verb: 'mis-pairs with', why: 'the bottle is capable but the cut earns a more decisive call' },
      ],
      'steak-lean': [
        { verb: 'overwhelms', why: 'the bourbon\'s weight crowds the filet\'s lean buttery frame — needs a softer call' },
      ],
      DEFAULT: [
  ...
  // SWEET_LIQUEUR — Frangelico, Disaronno, Sambuca, Limoncello, Baileys, Patron XO Cafe,
  // Pineau, Fireball. Core clash: sugar is dessert-course energy on savory plates.
  SWEET_LIQUEUR: {
    'main': {
      'main-fish-delicate': [
  ...
  // GIN — Botanist, Hendrick's, Empress, Tanqueray, Nolet's, Gray Whale, Plymouth.
  // Core clash: juniper-and-citrus botanicals don't fit the cut or sweet courses.
  GIN: {
    'dessert': {
      'dessert-chocolate': [
  ...
  // SWEET_WINE — Sauternes, Vin Santo, Port (Tawny / Vintage / LBV), Pineau, dessert Riesling.
  // Core clash: dessert wine is dessert-course energy on non-dessert courses.
  SWEET_WINE: {
    'main': {
      'main-fish-delicate': [
  ...
  // APERITIVO_BITTER — Campari, Aperol, Fernet Branca, Cynar, Amaro Lucano, sweet vermouth.
  // Core clash: bitter-herb register fights delicate, sweet, and cream registers.
  APERITIVO_BITTER: {
    'main': {
      'main-fish-delicate': [
  ...
  // COCKTAIL_BOLD — whiskey-forward (Old Fashioned, Manhattan, Sazerac, Vieux Carré,
  // Boulevardier, New York Sour, Pablo Sour). Carries whiskey weight + bitter/citrus.
  COCKTAIL_BOLD: {
    'main': {
      'main-fish-delicate': [
        { verb: 'overwhelms', why: 'whiskey-forward cocktail weight buries delicate fish — the cocktail belongs on red meat' },
        { verb: 'smothers', why: 'the bitters-and-bourbon register has no foil against gentle flesh' },
      ],
      'main-fish-rich': [
    ...
    'starter': {
      ...
      'starter-dairy': [
        { verb: 'fights', why: 'bourbon-and-bitter cocktail and fresh dairy refuse each other texturally' },
      ],
      'starter-meat': [
    ...
    'soup-salad': {
      ...
      'soup-salad-broth': [
        { verb: 'clashes with', why: 'bitter-and-bourbon cocktail and savory broth refuse each other' },
      ],
      'soup-salad-greens': [
    ...
    'side': {
      ...
      'side-glazed': [
        { verb: 'doubles down on', why: 'bourbon-cocktail sugar and glaze sugar compound without lift' },
      ],
      'side-starch': [
  ...
  // TEQUILA_BOLD — aged agave (Adictivo Cristalino, Komos, Casamigos Añejo, Don Julio Añejo).
  // Aged-agave + cask weight conflicts with delicate / sweet / cream registers.
  TEQUILA_BOLD: {
    'main': {
      'main-fish-delicate': [
  ...
  // RUM_LIGHT — light rums (Bacardi, Mount Gay, Captain Morgan, Malibu).
  // Phase 5 (Session 13): split from LIGHT_SPIRIT. Refine rum-specific language as needed.
  RUM_LIGHT: {
    'dessert': {
      'dessert-chocolate': [
  ...
  // TEQUILA_BLANCO — silver/blanco/plata/platinum tequilas.
  // Phase 5 (Session 13): split from LIGHT_SPIRIT. Refine agave-specific language as needed.
  TEQUILA_BLANCO: {
    'dessert': {
      'dessert-chocolate': [
        { verb: 'falls short of', why: 'light spirit can\'t carry chocolate\'s weight — needs a richer pour like an aged rum or tawny' },
  ...
  // COCKTAIL_LIGHT — citrus / gin / tequila cocktails (Margaritas, Daiquiris, Aviation,
  // Bee's Knees, French 75). Citrus-sweet register wrong for heavy savory courses.
  COCKTAIL_LIGHT: {
    'dessert': {
      'dessert-chocolate': [
  ...
  // WHITE_WINE — still whites (Chardonnays, Sauv Blancs, Pinot Blanc, Pouilly-Fumé,
  // dry Riesling). Wrong for dessert or for prime cuts.
  WHITE_WINE: {
    'dessert': {
      'dessert-chocolate': [
  ...
  // SPARKLING — Champagne, Cava, Prosecco. Wrong only for very heavy or specific dessert.
  SPARKLING: {
    'dessert': {
      'dessert-chocolate': [
  ...
  // VODKA — clean grain spirit (Belvedere, Grey Goose, Tito's, Ketel One).
  // Core clash: vodka brings no flavor anchor — AVOID is "doesn't add" rather than "fights".
  VODKA: {
    'dessert': {
      'dessert-chocolate': [
  ...
  // COGNAC — non-luxury (Hennessy, Courvoisier, Rémy Martin VSOP, Pierre Ferrand).
  // Core clash: digestif energy on savory courses.
  COGNAC: {
    'main': {
      'main-fish-delicate': [
  ...
  // MEZCAL — smoky agave. Core clash: smoke + agave fights delicate / sweet.
  MEZCAL: {
    'main': {
      'main-fish-delicate': [
  ...
  // HEAVY_SPIRIT — rare fallback class. Heavy non-classified spirits.
  HEAVY_SPIRIT: {
    'main': {
      DEFAULT: [
  ...
  // COGNAC_LUXURY — Louis XIII et al. Special-occasion icon; AVOIDs read "wrong moment".
  COGNAC_LUXURY: {
    'main': {
      DEFAULT: [
