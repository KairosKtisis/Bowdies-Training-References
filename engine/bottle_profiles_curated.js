...
const BOTTLE_PROFILES_CURATED = {
  ...
  'The Manhattan': {
    tastingNotes: ['rye whiskey, sweet vermouth, Angostura', 'classic cocktail', 'cherry-garnish ritual'],
    character:    'classic Manhattan with rye-and-vermouth depth',
    bridge1:      'the rye-vermouth body settles into {foodTarget}',
    bridge2:      'the cherry-bitters edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'classic Manhattan',
  },
  'French 75': {
    tastingNotes: ['gin, lemon, Champagne top', 'celebratory cocktail', 'effervescent build'],
    character:    'gin-and-Champagne lift with citrus snap',
    bridge1:      'the bubble-and-citrus build brightens {foodTarget}',
    bridge2:      'the gin botanicals frame {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'celebratory French 75',
  },
  'Margarita': {
    tastingNotes: ['blanco tequila, lime, salt rim', 'patio classic', 'agave-citrus build'],
    character:    'blanco-and-citrus margarita brightness',
    bridge1:      'the agave-citrus body brightens {foodTarget}',
    bridge2:      'the salt-rim edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'classic Margarita',
  },
  'Espresso Martini': {
    tastingNotes: ['vodka, espresso, coffee liqueur', 'after-dinner staple', 'bittersweet roast'],
    character:    'roasted-coffee martini richness',
    bridge1:      'the espresso depth meets {foodTarget}',
    bridge2:      'the coffee-liqueur edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'after-dinner Espresso Martini',
  },
  'Pierre Gimonnet Special Club Brut': {
    tastingNotes: ['blanc de blancs', 'grand cru Chardonnay', 'fine bead'],
    character:    'grand cru blanc-de-blancs with mineral lift',
    bridge1:      'the chalk-and-citrus body lifts {foodTarget}',
    bridge2:      'the fine bead frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'grand cru blanc-de-blancs',
  },
  'Veuve Clicquot Brut': {
    tastingNotes: ['yellow-label Champagne', 'pinot-driven blend', 'restaurant-pour standard'],
    character:    'classic yellow-label Champagne body',
    bridge1:      'the pinot-driven lift brightens {foodTarget}',
    bridge2:      'the toast-and-citrus edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'yellow-label Champagne',
  },
  'Raventós Cava de NIT Rosé Brut': {
    tastingNotes: ['rosé Cava', 'Penedès estate', 'red-fruit lift'],
    character:    'rosé Cava with red-fruit and floral lift',
    bridge1:      'the red-fruit Cava body lifts {foodTarget}',
    bridge2:      'the floral edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'rosé Cava',
  },
  'Vin Santo': {
    tastingNotes: ['Tuscan dessert wine', 'dried-fruit and honey', 'biscotti pour'],
    character:    'Tuscan dried-fruit-and-honey sweetness',
    bridge1:      'the dried-fruit body mirrors {foodTarget}',
    bridge2:      'the honey-nut edge threads {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'Tuscan Vin Santo',
  },
  "Graham's 20 Year Tawny": {
    tastingNotes: ['aged tawny port', 'nutty-caramel', 'Douro classic'],
    character:    'aged tawny with nutty-caramel depth',
    bridge1:      'the tawny depth wraps {foodTarget}',
    bridge2:      'the walnut-caramel edge threads {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'aged tawny port',
  },
  "Graham's 2017 Vintage Port": {
    tastingNotes: ['vintage port', 'structured dark-fruit', 'cellar-worthy'],
    character:    'structured vintage port with dark-fruit weight',
    bridge1:      'the vintage-port depth wraps {foodTarget}',
    bridge2:      'the dark-fruit-and-spice edge threads {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'vintage port',
  },
  'Taylor Fladgate Tawny': {
    tastingNotes: ['classic tawny port', 'caramel-nut character', 'restaurant standard'],
    character:    'classic tawny with caramel-nut sweetness',
    bridge1:      'the tawny body mirrors {foodTarget}',
    bridge2:      'the caramel-nut edge threads {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'classic tawny port',
  },
  'Keenan Chardonnay': {
    tastingNotes: ['Spring Mountain Chardonnay', 'oaked Napa', 'tropical-fruit and toast'],
    character:    'oaked Spring Mountain Chardonnay',
    bridge1:      'the toasted-Chard body lifts {foodTarget}',
    bridge2:      'the tropical-fruit edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'oaked Napa Chardonnay',
  },
  'Schloss Vollrads Riesling': {
    tastingNotes: ['Rheingau Riesling', 'off-dry German classic', 'lime-and-petrol'],
    character:    'off-dry Rheingau Riesling with lime-petrol edge',
    bridge1:      'the off-dry body brightens {foodTarget}',
    bridge2:      'the lime-petrol note threads {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'Rheingau Riesling',
  },
  'Faust Napa Valley Cabernet': {
    tastingNotes: ['Faust Napa Cab', 'Quintessa-family bottling', 'structured dark-fruit'],
    character:    'structured Napa Cab with cassis depth',
    bridge1:      'the structured-Cab body wraps {foodTarget}',
    ...
    verdictHook:  'Quintessa-family Napa Cab',
  },
  'Nickel & Nickel Cabernet': {
    tastingNotes: ['single-vineyard Napa Cab', 'concentrated dark-fruit', 'sister to Far Niente'],
    character:    'single-vineyard Napa Cab depth',
    bridge1:      'the concentrated body wraps {foodTarget}',
    bridge2:      'the cassis-and-oak edge frames {foodSubj}',
    bridge1Variants: [
    ...
    verdictHook:  'single-vineyard Napa Cab',
  },
};
