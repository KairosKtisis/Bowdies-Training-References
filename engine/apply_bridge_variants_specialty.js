...
const { BRIDGE_VARIANTS } = require('./bridge_variants_specialty');
...
const SANDBOX_PROF = '/sessions/adoring-serene-dijkstra/mnt/outputs/bottle_profiles_curated.specialty.js';
const SANDBOX_NOTES = '/sessions/adoring-serene-dijkstra/mnt/outputs/pairing-notes.bridge-variants-specialty.js';
...
console.log('Merged ' + mergeCount + '/' + Object.keys(BRIDGE_VARIANTS).length + ' bottles');
